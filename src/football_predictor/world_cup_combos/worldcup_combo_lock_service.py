...
def _leg_from_payload(payload: dict[str, Any]) -> ComboLegCandidate:
    return ComboLegCandidate(
        ...
        kickoff_display=payload.get("kickoff_display"),
        bookmaker_name=payload.get("bookmaker_name"),
        executable_decimal_odd=payload.get("executable_decimal_odd"),
        market_probability_consensus=payload.get("market_probability_consensus"),
